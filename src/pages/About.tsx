  ...
  return (
    <article className="max-w-3xl mx-auto px-6 pt-8 pb-32">
      ...
      <div className="space-y-6 text-sm leading-relaxed text-muted-foreground mb-16">
        ...
        <p>
          Varje kollektion släpps i små serier och många plagg tillverkas på beställning. Vi tror på att göra mindre och göra det väl. När du bär select me. bär du med dig stickornas rytm, garnets textur och omtanken från en hantverkare som brydde sig om varenda maska.
        </p>
      </div>

      {/* Attribution */}
      <p className="text-sm text-muted-foreground">
        Stickat av select me.
      </p>
    </article>
  );
}
